            ...
            <div className="w-full">
                ...
                <div className="container mx-auto px-4 pb-24">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                        ...
                        <div className="bg-background/80 backdrop-blur-sm rounded-xl p-8 shadow-lg border border-gray-200/20 transition-all duration-300 hover:shadow-xl">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mt-4 min-h-[24px]">
                                    {result && <div className="text-green-600 dark:text-green-400 text-sm font-medium p-2 rounded bg-green-50 dark:bg-green-900/20">{result}</div>}
                                    {error && <div className="text-red-600 dark:text-red-400 text-sm font-medium p-2 rounded bg-red-50 dark:bg-red-900/20">{error}</div>}
                                </div>
                            </form>
                        </div>

                        {/* Pin Container with improved styling */}
                        <div className="flex items-center justify-center">
                            <div className="transform hover:scale-105 transition-all duration-300">
                                <PinContainer
                                    ...
                                    href="/contact"
                                >
                                    <div className="flex basis-full flex-col p-6 tracking-tight text-slate-100/50 sm:basis-1/2 w-[22rem] h-[22rem] bg-black/20 backdrop-blur-md rounded-xl border border-white/10">
                                        ...
                                        <div className="flex flex-1 w-full rounded-lg mt-4 bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 overflow-hidden">
                                            <div className="w-full h-full p-6 flex items-center justify-center">
                                                <div className="text-white text-xl font-bold">Connect With Us</div>
                                            </div>
                                        </div>
                                    </div>
                                </PinContainer>
