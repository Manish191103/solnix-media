...
export const metadata: Metadata = {
  ...
  keywords: "web development, SMB solutions, digital marketing, website design, online presence",
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Google Tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-WDGHMRKXSK"></script>
        <script
